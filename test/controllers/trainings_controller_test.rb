...
class TrainingsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create training" do
    assert_difference("Training.count") do
      post trainings_url, params: { training: { repeticoes: @training.repeticoes, serie_training: @training.serie_training, type_training: @training.type_training } }
    end
  ...
  test "should update training" do
    patch training_url(@training), params: { training: { repeticoes: @training.repeticoes, serie_training: @training.serie_training, type_training: @training.type_training } }
