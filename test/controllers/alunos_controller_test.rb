...
class AlunosControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create aluno" do
    assert_difference("Aluno.count") do
      post alunos_url, params: { aluno: { dataMatricula: @aluno.dataMatricula, email: @aluno.email, nome: @aluno.nome, rg: @aluno.rg, telefone: @aluno.telefone } }
    end
  ...
  test "should update aluno" do
    patch aluno_url(@aluno), params: { aluno: { dataMatricula: @aluno.dataMatricula, email: @aluno.email, nome: @aluno.nome, rg: @aluno.rg, telefone: @aluno.telefone } }
