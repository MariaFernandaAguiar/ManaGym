...
class MachinesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create machine" do
    assert_difference("Machine.count") do
      post machines_url, params: { machine: { nome_machine: @machine.nome_machine, quan_machine: @machine.quan_machine, type_machine: @machine.type_machine } }
    end
  ...
  test "should update machine" do
    patch machine_url(@machine), params: { machine: { nome_machine: @machine.nome_machine, quan_machine: @machine.quan_machine, type_machine: @machine.type_machine } }
